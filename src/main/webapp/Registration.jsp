...
<<section class="p-5  text-center"
    ...
    <form class="mb-5 mx-md-5" action="UserRegisterServlet" method="POST">
        ...
        <div class="col-md-4 mb-4" style="margin: auto;">
            <input type="password" id="password1" class="form-control" name="confirm-password" placeholder="Repeat password"/>
        </div>
        <div class="text-center">
            <button type="submit" class="btn btn-elegant">Sign up</button> <br><br>
        </div>
    </form>
</section>
</body>
